...
namespace Sop.Common.Img.Tests
{
    public class ImgAnimateTest
    {
        ...
        public void GetGifImage_Test()
        {
            ...
            var isok = ImgAnimate.Instance().GetGifImage(imageFilePaths, outputImagePath);
        ...
        public void SetGifImage_Test()
        {
            ...
            var success = ImgAnimate.Instance().SetGifImage(imageGifPath, outputFilePath, out var list);
