...
namespace Sop.Common.Img.Utility
{
    ...
    public static class MimeTypeMap
    {
        ...
        /// 获取MimeType类型
        /// </summary>
        /// <param name="extension">扩展名:jpg or .jpg</param>
        /// <returns></returns>
        ...
        /// 
        /// </summary>
        private static readonly Lazy<IDictionary<string, string>> _mappings = new Lazy<IDictionary<string, string>>(new Func<IDictionary<string, string>>(MimeTypeMap.BuildMappings));
        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        private static IDictionary<string, string> BuildMappings()
        {
            ...
            List<KeyValuePair<string, string>> list = dictionary.ToList<KeyValuePair<string, string>>();
